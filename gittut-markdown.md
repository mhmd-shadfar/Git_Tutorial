...
`git log --pretty=format:”%Cgreen%an%Creset committed %H”` note that `%an` for author name and `%Cgreen` to Change color of author name in green and `%Creset` to resert color after green.
